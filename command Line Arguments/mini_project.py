...
try:
    like_str = input("Enter liked numbers (e.g. 3-1): ")
    dislike_str = input("Enter disliked numbers (e.g. 5-7): ")
    input_str = input("Enter given numbers (e.g. 1-5-3-8): ")
    ...
    print("Error: Please enter only numbers separated by hyphens.")
